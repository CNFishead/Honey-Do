  ...
  return (
    <Container fluid style={{ height: "100%" }} className="home-container">
      ...
      >
        <Row style={{ textAlign: "center", width: "75%" }}>
          <Col>
            <p style={{ display: "inline", fontFamily: "serif" }}>
              <span style={{ fontWeight: "bold" }}>The Honey-Do app</span> was
              developed with one thing in mind, to be able to easily track your
              to-do's and organize your life. You'll not find a more
              user-friendly, easier way to keep track of your daily workload. An
              exceptional app Built and maintained by
              <a
        ...
        <Row style={{ width: "100%", textAlign: "center", padding: "5% 0" }}>
          <Col>
            <Link to="/register">
